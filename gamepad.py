...
dll_path = "vXboxInterface.dll"  #the dll that is required to emulate the JOY stick
...
#XInputDevices means any devices that are capable of recieving and sending directX commands
class XInputDevice:
